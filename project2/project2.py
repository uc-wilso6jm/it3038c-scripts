...
while pwSize < 8: # While loop checks if the value entered is less than 8. If it is, you are prompted that the length is too short and to re-enter a new length greater than 8.
